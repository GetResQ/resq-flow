...
export const themeTokens = {
  ...
  light: {
    ...
    canvasBg: '#ffffff',
    canvasDot: 'transparent',
    edgeDefault: '#B0B8C4',
    edgeDimmed: '#D1D5DB',
    marker: '#B0B8C4',
    nodeQueue:    { border: 'rgba(220,130,0,0.45)',   bg: '#FFF8ED', text: '#92400e', accent: '#DC8200' },
    nodeWorker:   { border: 'rgba(0,140,240,0.45)',   bg: '#F0F4FF', text: '#1e3a5f', accent: '#008CF0' },
    nodeCron:     { border: 'rgba(100,116,139,0.35)', bg: '#F2F4F7', text: '#475569', accent: '#64748B' },
    nodeProcess:  { border: 'rgba(59,130,246,0.24)',  bg: '#EFF4FF', text: '#1e3a8a', accent: '#60A5FA' },
    nodeDecision: { border: 'rgba(130,70,220,0.45)',  bg: '#F5F0FF', text: '#4c1d95', accent: '#8246DC' },
    nodeResource: { border: 'rgba(0,150,150,0.40)',   bg: '#EEFAF9', text: '#155e75', accent: '#009696' },
    nodeTrigger:  { border: 'rgba(22,163,74,0.35)',   bg: '#EEFBF0', text: '#166534', accent: '#16A34A' },
    nodeDetail:   { border: 'rgba(100,116,139,0.32)', bg: '#F2F4F7', text: '#64748b', accent: '#94A3B8' },
