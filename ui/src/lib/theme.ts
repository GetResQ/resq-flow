...
export const themeTokens = {
  ...
  light: {
    ...
    edgeDimmed: '#D1D5DB',
    marker: '#B0B8C4',
    nodeQueue:    { border: 'rgba(200,120,0,0.55)',   bg: '#FFF5E1', text: '#92400e', accent: '#DC8200' },
    nodeWorker:   { border: 'rgba(0,120,220,0.55)',   bg: '#EBF0FF', text: '#1e3a5f', accent: '#008CF0' },
    nodeCron:     { border: 'rgba(100,116,139,0.45)', bg: '#EDEEF2', text: '#475569', accent: '#64748B' },
    nodeProcess:  { border: 'rgba(59,130,246,0.38)',  bg: '#EAF0FF', text: '#1e3a8a', accent: '#60A5FA' },
    nodeDecision: { border: 'rgba(130,70,220,0.55)',  bg: '#F0E8FF', text: '#4c1d95', accent: '#8246DC' },
    nodeResource: { border: 'rgba(0,140,140,0.50)',   bg: '#E8F7F6', text: '#155e75', accent: '#009696' },
    nodeTrigger:  { border: 'rgba(22,150,70,0.48)',   bg: '#E8F8EA', text: '#166534', accent: '#16A34A' },
    nodeDetail:   { border: 'rgba(100,116,139,0.40)', bg: '#EDEEF2', text: '#64748b', accent: '#94A3B8' },
