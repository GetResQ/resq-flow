...
describe('WaterfallChart', () => {
  ...
  it('renders bars for each span', () => {
    const spans: SpanEntry[] = [
      makeSpan({ spanId: 's1', spanName: 'parse-headers', nodeId: 'parse', durationMs: 42, startTime: '2024-01-01T00:00:00.000Z', endTime: '2024-01-01T00:00:00.042Z' }),
      makeSpan({ spanId: 's2', spanName: 'analyze', nodeId: 'analyze', durationMs: 120, startTime: '2024-01-01T00:00:00.042Z', endTime: '2024-01-01T00:00:00.162Z' }),
      makeSpan({ spanId: 's3', spanName: 'send-reply', nodeId: 'send', durationMs: 80, startTime: '2024-01-01T00:00:00.162Z', endTime: '2024-01-01T00:00:00.242Z' }),
    ]
  ...
  it('shows total and critical path duration', () => {
    const spans: SpanEntry[] = [
      makeSpan({ spanId: 's1', spanName: 'a', durationMs: 50, startTime: '2024-01-01T00:00:00.000Z', endTime: '2024-01-01T00:00:00.050Z' }),
      makeSpan({ spanId: 's2', spanName: 'b', durationMs: 100, startTime: '2024-01-01T00:00:00.050Z', endTime: '2024-01-01T00:00:00.150Z' }),
    ]
