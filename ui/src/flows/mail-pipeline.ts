...
export const spanMapping: SpanMapping = {
  ...
  'backfill.write_threads': 'write-threads',
  'backfill.write_metadata': 'write-metadata',
  'incoming.write_threads': 'write-threads',
  'incoming.write_metadata': 'write-metadata',
  'incoming.cursor_update': 'write-cursor',
  'scheduler.cursor_update': 'write-cursor',
  'analyze.decision': 'analyze-decision',
  ...
  'analyze.execute_enqueue': 'analyze-worker',
  'actions.execute_result': 'analyze-worker',
  'actions.send_enqueue': 'analyze-worker',
  'approval.execute_enqueue': 'analyze-worker',
